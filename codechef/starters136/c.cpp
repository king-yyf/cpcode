...
// 24 8 12 24 
// 120 12 24 72 120 
// 720 72 144 240 480 720 
// 5040 144 480 720 2160 3600 5040 
// 40320 1152 1440 5760 10080 20160 30240 40320

// 24 6 12 24 
// 120 8 24 72 120 
// 720 30 120 240 480 720 
// 5040 36 144 720 2160 3600 5040 
// 40320 168 840 5040 10080 20160 30240 40320
...
void solve(int tt) {
    ...
    for(int i=2;i<n;++i){
    	...
    	ll cu=(i-1ll)*(x+1)+x;
    	ll t=cu-n;
    	mint cc=comb.fact(x)*comb.fact(n-x);
    	cc=cc*(t+1);
    	c[i]=cc;
    }
