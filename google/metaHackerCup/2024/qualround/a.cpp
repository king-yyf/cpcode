...
int main() {
    freopen("/Users/yangyf/Downloads/walk_the_line_input.txt","r",stdin);
    freopen("/Users/yangyf/Desktop/cpcode/google/metaHackerCup/2024/qualround/a1_ans2.txt","w",stdout);
    int T = 1, fun_type = 2;
    cin >> T;
