...
int main() {
    freopen("/Users/yangyf/Downloads/line_by_line_input.txt","r",stdin);
    freopen("/Users/yangyf/Desktop/cpcode/google/metaHackerCup/2024/qualround/b_2.txt","w",stdout);
    int T = 1, fun_type = 0;
    cin >> T;
