...
true_type check_value(int);
template <typename T>
false_type check_value(long);
} // namespace detail
...
void yes(bool t = 1) { print(t ? "yes" : "no"); }
void no(bool t = 1) { yes(!t); }
#line 6 "/home/maspy/library/my_template.hpp"
...
#line 2 "/home/maspy/library/mod/modint.hpp"
template <int mod>
struct modint {
...
#line 1 "/home/maspy/library/nt/primetable.hpp"
...
#line 2 "/home/maspy/library/nt/primesum.hpp"
...
void solve() {
  ...
  auto [sum_lo, sum_hi] = primesum<I>(N);
  ll m = len(sum_lo_0);
